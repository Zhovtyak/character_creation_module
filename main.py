...
def attack(char_name, char_class):
    """Функция, описывающая нанесение урона."""
...
def defence(char_name, char_class):
    """Функция, описывающая оборону персонажа."""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Функция, описывающая спец возможности персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Функция, описывающая выбор действий персонажа."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Функция, описывающая выбор класса персонажа и его набор функций."""
    approve_choice = None
    char_class = None
